        ...
        <div className="min-h-screen bg-bg text-fg px-6 py-24 md:py-32 md:px-10 lg:px-16">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-lg prose-invert max-w-none font-sans text-mute leading-relaxed space-y-6">
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">Panoramica</h2>
                    <p>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">a) Chi siamo</h2>
                    <p>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">b) Perché raccogliamo i dati</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">c) Quali dati raccogliamo dall'utente?</h2>

                    <h3 className="font-display font-semibold text-xl text-fg mt-6 mb-2">Dati forniti dall'utente</h3>
                    ...
                    <h3 className="font-display font-semibold text-xl text-fg mt-6 mb-2">Modalità di esecuzione</h3>
                    ...
                    <h3 className="font-display font-semibold text-xl text-fg mt-6 mb-2">Dati raccolti sull'utente</h3>
                    ...
                    <h3 className="font-display font-semibold text-xl text-fg mt-6 mb-2">Quali conseguenze in caso di mancato o incompleto conferimento dei dati</h3>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">d) A chi comunichiamo i dati</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">e) Trasferimenti internazionali</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">f) Dispositivi mobili</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">g) Social media</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">h) Minori</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">i) Come e per quanto tempo trattiamo i Suoi dati</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">j) I diritti riconosciuti dal Codice Privacy e dal Regolamento</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">k) Informativa sull'uso dei Cookies</h2>
                    ...
                    <h2 className="font-display font-medium text-2xl md:text-3xl text-fg mt-8 mb-4">l) Modifiche alla presente Politica di Riservatezza</h2>
