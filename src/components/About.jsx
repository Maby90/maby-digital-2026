                            ...
                            <div className="panel overflow-hidden">
                                <div className="aspect-[4/5] w-full overflow-hidden bg-elev">
                                    <img
                                        ...
                                        alt="Maby Prochilo, digital strategist e AI marketing consultant a Firenze"
                                ...
                                <div className="p-4 border-t border-line bg-elev/40 flex items-center justify-between">
                                    <div>
                                        ...
                                        <div className="font-mono text-[11px] text-mute">Sistemi AI · Firenze</div>
                                    </div>
