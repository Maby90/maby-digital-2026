...
const SkillLavagne = () => {
    useSeo({
        ...
        jsonLd: {
            ...
            '@type': 'WebPage',
            '@id': 'https://mprochilo.it/skill-lavagne#page',
            name: 'Skill Claude per lavagne Excalidraw, gratis',
            description: 'Scarica la skill Claude che uso per generare schemi e lavagne Excalidraw: flussi, timeline, confronti, mappe concettuali.',
            url: 'https://mprochilo.it/skill-lavagne',
            inLanguage: 'it-IT',
    ...
    useEffect(() => {
        try {
            localStorage.setItem('mp_lead_source', 'skill-lavagne');
                        ...
                        <div className="lg:col-span-7">
                            <div className="flex flex-wrap items-center gap-3 mb-8">
                                ...
                                <span className="hidden md:inline-flex pill">
                                    <span className="text-mint">skill</span> · Claude
                                </span>
                            </div>
                            ...
                            <h1 className="font-display font-medium text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[1.02] tracking-tightest text-fg text-balance">
                                Scarica la skill <span className="text-mint">Claude</span> che uso per trasformare un concetto in una lavagna Excalidraw in un minuto.
                            </h1>

                            <p className="mt-8 text-mute text-lg md:text-xl leading-relaxed max-w-2xl">
                                La stessa skill con cui costruisco gli schemi della mia newsletter: flussi, timeline, confronti, mappe concettuali, cicli. Dici a Claude cosa vuoi visualizzare, ti restituisce un file <span className="text-fg">.excalidraw</span> già editabile. Zero Canva, zero abbonamenti.
                            </p>
                            ...
                            <ul className="mt-10 space-y-3 max-w-2xl">
                                {[
                                    ...
                                    'Otto tipi di schema: flusso, confronto, hub & spoke, matrix, timeline, piramide, prima/dopo, ciclo',
                                    'Script Python senza dipendenze: gira ovunque ci sia Python 3',
                                    'File .excalidraw che apri gratis su excalidraw.com, già editabili',
                                ].map((b) => (
                            ...
                            <div className="lg:sticky lg:top-24">
                                <div className="panel overflow-hidden shadow-[0_0_60px_-15px_rgb(var(--mint)/0.25)]">
                                    ...
                                    <div className="p-5 md:p-6">
                                        <div className="font-mono text-sm text-mint mb-4">$ get --skill "lavagne-excalidraw"</div>
                                        ...
                                        <div className="flex items-center gap-3 mb-5">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-mute text-xs">La skill è scaricabile subito dopo</div>
                                            </div>
                                        </div>
            ...
            <section className="bg-surface/40 py-20 md:py-28 border-b border-line">
                <div className="container-edge">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 max-w-5xl">
                        {[
                            { n: '01', t: 'Skill Claude', d: 'La cartella `.skill` pronta da mettere nel tuo workspace Claude. SKILL.md già configurato con gli otto tipi di schema.' },
                            { n: '02', t: 'Generatore Python', d: 'Uno script senza dipendenze che produce file .excalidraw validi. Gira ovunque ci sia Python 3.' },
                            { n: '03', t: 'Otto layout', d: 'Flusso, confronto, hub & spoke, matrix 2x2, timeline, piramide, prima/dopo, ciclo. Palette e font già impostati.' },
                            { n: '04', t: 'Guida di setup', d: 'README passo per passo: come installare la skill e come chiederle il primo schema. Pensato anche per chi parte da zero.' },
                        ].map((s) => (
                    ...
                    <div className="grid lg:grid-cols-12 gap-10">
                        ...
                        <div className="lg:col-span-9 max-w-3xl">
                            ...
                            <p className="text-mute text-base md:text-lg leading-relaxed mb-6">
                                Lavoro su marketing e AI automation per freelance, PMI e B2B. Su <strong className="text-fg">Oltre il prompt</strong> pubblico ogni settimana una guida operativa: workflow Claude, automazioni, prompt che funzionano, costi reali. Niente curiosity-driven, niente news, niente motivazionale.
                            </p>
